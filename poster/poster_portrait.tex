...
%  background=shade-tb,
  ...
  % Eye Catcher
  {\includegraphics[height=8.0em]{images/logo.eps}} 
  % Title
  {\bf\textsc{Test of Goodness of Population Receptive Field Estimates}\vspace{0.5em}}
  % Authors
  {\textsc{ Arash.Ashrafnejad and Hossein.Mehrzadfar and Huseyin.Boyaci @bilkent.edu.tr}}
  % University logo
  {% The makebox allows the title to flow into the logo, this is a hack because of the L shaped logo.
    \includegraphics[height=9.0em]{images/bilkent.eps}
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \noindent{\centering\includegraphics[width=0.95\linewidth]{images/method.eps}\\}
